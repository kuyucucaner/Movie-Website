...
fetch('/user-seven-plused-movies')
  .then(response => {
    if (!response.ok) {
...
function displayPage(page) {
  ...
  displayedMovies.forEach(movie => {
    ...
    overlayText.classList.add('user-overlay-text');
    overlayText.textContent = movie.MovieName;

    const typeText = document.createElement('div');
    typeText.classList.add('user-type-text');
